...
if (!env.IS_DOCKER) {
	...
	export const environment: Environment = 
	{
		...
		COMPANY_NAME: 'Buciko Codes',
		COMPANY_SITE: 'Buciko-HRMS+',
		COMPANY_LINK: 'https://buciko-codes.co/',
		COMPANY_SITE_LINK: 'https://buciko-codes.co',
		COMPANY_GITHUB_LINK: 'https://github.com/buciko-codes',
		COMPANY_GITLAB_LINK: 'https://gitlab.com/buciko-codes',
		COMPANY_FACEBOOK_LINK: 'https://www.facebook.com/buciko-codes',
		COMPANY_TWITTER_LINK: 'https://twitter.com/buciko-codes',
		COMPANY_LINKEDIN_LINK: 'https://www.linkedin.com/company/buciko-codes',
